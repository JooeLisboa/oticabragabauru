...
export function ReviewsSection() {
  return (
    <SectionContainer>
      <SectionTitle title={sectionCopy.reviewsTitle} subtitle={sectionCopy.reviewsSubtitle} />
      ...
      >
        {brand.reviews.map((review) => (
          <motion.div key={review.author} variants={{ hidden: { opacity: 0, y: 20 }, show: { opacity: 1, y: 0 } }}>
